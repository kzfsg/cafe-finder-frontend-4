...
const MerchantSignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Form validation
    if (!formData.username || !formData.email || !formData.password || !formData.confirmPassword || !formData.businessName) {
    ...
    try {
      ...
      // Use the register function from AuthContext with merchant flag
      const result = await register(
        formData.username,
        formData.email,
        formData.password,
        true // is_merchant = true
      );
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-footer">
          <p>Want a regular account instead? <Link to="/signup">Sign up as a user</Link></p>
