...
import { IconFilter, IconThumbUp, IconMapPin, IconSearch, IconX } from '@tabler/icons-react';
import { Stack, Text, Loader, SegmentedControl, TextInput, Select, Checkbox, Button } from '@mantine/core';
...
export default function EnhancedSearchBar({ onSearch }: EnhancedSearchBarProps) {
  ...
  const isFiltersComplete = !!(filters.wifi || filters.powerOutlet || filters.seatingCapacity || 
                              filters.noiseLevel || filters.priceRange);
      ...
      >
        ...
        <div className="upvotes">
          ...
          <div className="search-value">
            ...
            {filters.upvotes ? `Min ${filters.upvotes}+` : 'Min upvotes'}
          </div>
        </div>
          ...
          <>
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 600 }}>Find Your Perfect Cafe</h2>
                <button
                  onClick={handleClose}
                  style={{
                    background: 'none',
                ...
                {['location', 'filters', 'upvotes'].map((step, index) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '2px',
                      backgroundColor: 
                        step === 'location' && isLocationComplete ? '#d74f00' :
                        step === 'filters' && isFiltersComplete ? '#d74f00' :
                        step === 'upvotes' && isUpvotesComplete ? '#d74f00' :
                        currentStep === step ? '#d74f00' : '#e9ecef'
                    }}
                  />
                ))}
              </div>
              ...
              <AnimatePresence mode="wait">
                {currentStep === 'location' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, x: -20 }}
                  >
                    <h3 style={{ marginBottom: '1rem' }}>Where would you like to find cafes?</h3>
                    <Stack gap="md">
                      <SegmentedControl
                        data={[
                      ...
                      {isLocationComplete && (
                        <Button
                          ...
                          style={{ backgroundColor: '#d74f00', marginTop: '1rem' }}
                          size="md"
                        >
                          Continue to Filters
                        </Button>
                ...
                {currentStep === 'filters' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, x: -20 }}
                  >
                    <h3 style={{ marginBottom: '1rem' }}>What amenities are important to you?</h3>
                    <Stack gap="md">
                      <Checkbox
                ...
                {currentStep === 'upvotes' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, x: -20 }}
                  >
                    <h3 style={{ marginBottom: '1rem' }}>How popular should the cafes be?</h3>
                    <Stack gap="md">
                      <Select
                ...
                {currentStep === 'ready' && (
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      <h3 style={{ marginBottom: '1rem' }}>Ready to find your perfect cafe!</h3>
